...
public class IatSessionParam {
     ...
     */
    private String eos = "999999";

    private String bos = "999999";
    ...
    public String getPgs_mode() {
        return pgs_mode;
    }

    public void setPgs_mode(String pgs_mode) {
        this.pgs_mode = pgs_mode;
    }

    private String pgs_mode = "simple";
    ...
    public IatSessionParam(String sid, String aue, String rst, String rse,
                           String eos, String dwa, String wbest, String wbestonlyper,
                           String rate, String hotword, String samplesInfo,
                           String pgs_mode) {
        this.sid = sid;
        this.aue = aue;
        this.rst = rst;
