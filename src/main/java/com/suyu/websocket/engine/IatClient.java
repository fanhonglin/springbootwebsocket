...
import com.suyu.websocket.core.Dictation;
import com.suyu.websocket.core.IatGrpc;
import com.suyu.websocket.exception.IatException;
...
public class IatClient implements AutoCloseable {
     ...
     * connect() 连接引擎,私有方法
     *
     * @throws IatException 连接异常
     */
    private void postConnect() throws IatException {
        ...
        try {
            ...
            if (!StringUtil.isNullOrEmpty(iatSessionParam.getPgs_mode())) {
            ...
            if (!StringUtil.isNullOrEmpty(iatSessionParam.getBos())) {
            ...
            throw new IatException("requestStreamObserver.onNext() error");
        }
    }
